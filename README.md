Python-ML — My AIML Learning Journey

A structured and practical repository documenting my complete journey into Python, Data Handling, Data Visualization, EDA, and foundational Machine Learning.
This repo contains notebooks, scripts, datasets, and mini-projects — all created as part of my preparation for Artificial Intelligence & Machine Learning specialization.
...
A collection of beginner-friendly EDA and visualization projects.
Includes:
...
✔ My fundamentals in Data Science & ML
✔ My hands-on practice in Python
✔ My journey into AIML specialization
✔ My transition from basics → ML → DL
✔ My readiness for future AI/ML projects
